import { Users, TrendingUp, Video, Tag, Eye, PlayCircle, Home, MessageCircle, Settings, FileText, Palette, Activity, PlaySquare, Star } from "lucide-react";
      ...
      <div className="p-6 max-w-7xl mx-auto w-full">
        <div className="flex justify-between items-center mb-8 pt-4">
          <div>
            ...
            <h2 className="text-2xl md:text-4xl font-bold">Oficina do Corpo</h2>
          </div>
          ...
          <div className="flex items-center">
            ...
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full overflow-hidden border-2 border-emerald-500 relative bg-gray-800">
              <Image src="https://i.pravatar.cc/150?img=11" alt="Profile" fill className="object-cover" />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8">
          <div className="bg-gray-800 p-5 md:p-8 rounded-3xl border border-gray-700 shadow-lg">
        ...
        {/* Ações Rápidas */}
        <h3 className="font-bold mb-4 md:text-lg">Ações Rápidas</h3>
        <div className="flex gap-4 mb-8 overflow-x-auto hide-scrollbar pb-2">
          <button className="bg-gray-800 hover:bg-gray-700 transition-colors border border-gray-700 min-w-[100px] md:min-w-[140px] p-4 rounded-2xl flex flex-col items-center justify-center text-sm md:text-base gap-2">
          ...
          <Link href="/student">
            <button className="bg-gray-800 hover:bg-gray-700 transition-colors border border-emerald-500/30 min-w-[120px] md:min-w-[150px] p-4 rounded-2xl flex flex-col items-center justify-center text-sm md:text-base gap-2 text-emerald-400">
        ...
        {/* Últimos Conteúdos */}
        <h3 className="font-bold mb-4 md:text-lg">Últimos Conteúdos</h3>
