  ...
  useEffect(() => {
    if (currentUser && userProfile) {
      ...
      if (userProfile.role === "professional") {
        targetPath = userProfile.paymentStatus === "paid" 
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="text-center mt-6">
            <a className="text-sm text-gray-500 hover:text-emerald-400 transition-colors" href="/register-user/">Ainda não tem conta? <span className="font-bold underline">Começar Agora</span></a>
          </div>
        </form>
      </div>
    </div>
