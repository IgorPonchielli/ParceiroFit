      ...
      <div className="bg-gray-900 border-b border-gray-800 z-10 w-full relative">
        <div className="max-w-4xl mx-auto p-4 flex items-center pt-8 md:pt-4 justify-between">
          <div className="flex items-center">
            <Link href="/student" className="mr-4 text-gray-400 hover:text-white transition">
              <ArrowLeft />
            </Link>
            <div className="w-10 h-10 rounded-full overflow-hidden border border-gray-700 relative mr-3">
               <Image src="https://i.pravatar.cc/150?img=11" fill alt="Prof" className="object-cover" />
            </div>
            <div>
              <h3 className="font-bold text-sm md:text-base">Prof. Oficina do Corpo</h3>
      ...
      <div className="flex-1 overflow-y-auto w-full pb-24">
        <div className="max-w-4xl mx-auto p-4 space-y-6">
          ...
          <div className="flex flex-col items-start max-w-[85%] md:max-w-[70%]">
            <div className="bg-gray-800 p-3 md:p-4 rounded-2xl rounded-tl-sm text-sm md:text-base shadow-md text-white">
